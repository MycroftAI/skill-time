Feature: Current Time
  ...
  Scenario Outline: what time is it
    Given an english speaking user
     ...
     Then "mycroft-date-time" should reply with dialog from "time-current-local.dialog"
  ...
  Scenario Outline: what's the time in a location
    Given an english speaking user
     ...
     Then "mycroft-date-time" should reply with dialog from "time-current-location.dialog"
